    ...
    <div class="container my-auto">
        <div class="row">
            <div class="col">
                ...
                <h2 class="text-center text-light mb-5">Register</h2>
            </div>
        </div>
        <form method="POST" action="{{ route('register') }}" id="form-register">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 d-block mx-auto">
                    <input id="name" type="text"
                        class="form-control @error('name') is-invalid @enderror remove-focus bg-transparent placeholder text-light cursor"
            ...
            <div class="row d-flex">
                <div class="col-md-4 mx-auto">
                    <a type="submit" class="btn d-block mx-auto action-button mb-4"
                        onClick="document.getElementById('form-register').submit()" role="button">
                        Register
                    </a>
                    <p class="text-light text-center mb-2">Already have account?</p>
                    <a href="/login" class="btn btn-light mx-auto d-block fw-semibold">Login to existing account</a>
                </div>
            </div>
        </form>
    </div>
